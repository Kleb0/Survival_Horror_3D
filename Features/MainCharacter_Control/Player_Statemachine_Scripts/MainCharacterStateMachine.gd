...
func _ready():	
	...
	mainCharacter_AnimationPlayer = $"../test_character_Node3D/MainCharacter_AnimationPlayer"
	mainCharacter_animationTree = $"../test_character_Node3D/MainCharacter_AnimationTree"
